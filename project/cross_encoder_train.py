...
train_dataset = scidoc_cite_to_train_triplets(
    load_scidocs_cite()["train"].shard(100, 0)
)
...
query = (
    "Surface Reconstruction from Point Clouds via Grid-based Intersection Prediction [SEP] "
