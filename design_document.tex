...
loss on the training set of the SciDocs dataset. Whereas the re-ranking model will be trained on pairs of relevant and
non-relevant documents for a given query using the pairwise hinge loss. The following combinations of embedding models
