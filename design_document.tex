...
\begin{abstract}
  ...
  evaluation of a recommender system specifically designed to suggest relevant research papers based on user queries or
  existing papers. Due to the difficulty of user studies and live evaluations, we will focus on offline evaluation
  methods and how to use the citation graph for fine tuning and evaluation. Furhtermore, we will compare different models
...
\section{Evaluation and Metriks}
By using the citation graph, we can evaluate the performance of our recommender system in an offline setting. TODO:
elaborate further how exactly. Our evaluation method is based on the "leave-one-out" strategy
(\cite{EkstrandResearchLists}), ... TODO describe what we will be doing.
...
\begin{figure}[h!]
  ...
  \end{tikzpicture}
  \caption{Just a placeholder \color{red}TODO REPLACE}
